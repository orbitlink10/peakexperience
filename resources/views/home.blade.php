...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}body{font-family:'Manrope',sans-serif;color:var(--ink);background:radial-gradient(circle at top left,rgba(66,210,189,.18),transparent 28%),radial-gradient(circle at top right,rgba(240,140,44,.16),transparent 30%),linear-gradient(180deg,var(--bg) 0,var(--bg2) 25rem,var(--paper) 25rem,#f7f2e9 100%)}img{display:block;max-width:100%}a{color:inherit}section[id]{scroll-margin-top:7rem}
        ...
        .header{position:sticky;top:0;z-index:20;background:rgba(8,17,32,.72);backdrop-filter:blur(14px);border-bottom:1px solid rgba(255,255,255,.08)}.header .container{min-height:5.3rem}.brand{display:inline-flex;align-items:center;gap:.9rem;text-decoration:none;color:#fffaf1}.brand-mark{width:2.9rem;height:2.9rem;border-radius:1rem;display:grid;place-items:center;background:linear-gradient(140deg,rgba(240,140,44,.92),rgba(66,210,189,.8));color:#081120;font:800 1.2rem 'Syne',sans-serif;box-shadow:0 18px 35px rgba(240,140,44,.28)}.brand strong{display:block;font:800 1.28rem 'Syne',sans-serif;line-height:1}.brand span{display:block;margin-top:.2rem;color:rgba(255,250,241,.62);font-size:.72rem;letter-spacing:.18em;text-transform:uppercase;font-weight:700}
        ...
        main{padding:4.5rem 0 5rem}.section{margin-bottom:5.4rem}.section-head{display:grid;grid-template-columns:minmax(0,1fr) minmax(280px,.78fr);gap:1.5rem;align-items:end;margin-bottom:1.7rem}.section h2,.cta h2{font-size:clamp(2.2rem,5vw,4rem)}.section-head p,.cta p{color:var(--muted);line-height:1.7}
        ...
        @media (max-width:560px){.topbar{display:none}.hero h1{font-size:2.7rem}.actions,.cta-actions{flex-direction:column}.btn,.pill{width:100%}}
    </style>
</head>
<body id="top">
    <div class="topbar">
    ...
    <section class="hero">
        <div class="container hero-grid">
            <div>
                ...
                <h1>Sharper stages. Cleaner execution. Better show moments.</h1>
                <p>PeakExperience helps brands, organisers, and production teams deliver polished live experiences with tighter staging, stronger media systems, and practical execution from first brief to final cue.</p>
        ...
        <section class="section container" id="services">
            <div class="section-head">
                <div>
                    ...
                    <h2>Production services built to carry the room.</h2>
                </div>
